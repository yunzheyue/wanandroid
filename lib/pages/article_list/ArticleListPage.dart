...
///这里使用with进行扩展类，可以在后面跟随多个扩展类，
///这样就能在本类中进行使用扩展类的非私有的方法和属性
///AutomaticKeepAliveClientMixin  是自动保存数据
...
//     这个是滚动的监听，每次滚动的时候就会调用
      onNotification: onScrollNotification,
//     使用RefreshIndicator进行刷新  这个是进行调用下拉刷新
...
//    pixels表示的是当前滚动的位置。  maxScrollExtent表示的是最大能够滚动的距离
//  如果是滚动的距离的位置大于能滚动的位置，那么就进行滚动。
